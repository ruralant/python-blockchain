...
class Blockchain:
    """The Blockchain class manages the chain as well as open
    transactions and the node where it's running.
    ...
    def save_data(self):
        """Save blockchain and open transactions snapshot on a file. """
        try:
    ...
    def add_peer_node(self, node):
        ...
        Arguments:
            :node: The peer node which should be added.
        """
    ...
    def remove_peer_node(self, node):
        ...
        Arguments:
            :node: The peer node which should be removed.
        """
